...
states = {
  ...
  'events': [
    ...
    {'name': 'service_notfound',  'src': 'finding_service',  'dst': 'playing_invaliddialednum'},
    {'name': 'playcomplete_invaliddialednum',  'src': 'playing_invaliddialednum',  'dst': 'playing_thankyou'}, #<here it continue to release call>
    {'name': 'calldisconnect',  'src': ['validate_incall', 'invalidsrc_playing_welcome', 'src_profile_creation', 'playing_welcome', 'finding_service', 'playing_invalidsrc', 'playing_thankyou', 'new_user_playing_welcome', 'new_user_playing_langselect','playing_langset', 'playing_invaliddialednum'],  'dst': 'calldisconnected'}, #<when user disconnects the call>
  ...
  'callbacks': {
    ...
    'onplaying_invaliddialednum':    onplaying_invaliddialednum,
